...
class FactorComputeComponentTest:
    ...
    def generate_mock_tasks(self, count: int = 50) -> List[Dict[str, Any]]:
        ...
        factor_names = [
            'RSI_14', 'MACD_Signal', 'Bollinger_Bands', 'Moving_Average_20',
            'Volume_Ratio', 'Price_Momentum', 'Volatility_Index', 'Beta_Factor',
            'Alpha_Factor', 'Sharpe_Ratio', 'Information_Ratio', 'Treynor_Ratio'
        ]
