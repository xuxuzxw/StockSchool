...
def main():
    ...
    total_passed = (api_passed + websocket_passed + lifecycle_passed + 
                   data_flow_passed + interaction_passed + error_passed)
    total_tests = (len(results['api_tests']) + len(results['websocket_tests']) + 
                  len(results['lifecycle_tests']) + len(results['data_flow_tests']) + 
                  len(results['interaction_tests']) + len(results['error_tests']))
