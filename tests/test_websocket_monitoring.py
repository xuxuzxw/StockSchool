...
async def test_message_types():
    ...
    try:
        ...
        # 测试WebSocket消息
        message = WebSocketMessage(type=MessageType.DATA, data={"test": "data"})
...
async def test_message_handling():
    ...
    try:
        from src.websocket.monitoring_websocket import MessageType, MonitoringWebSocketServer, SubscriptionType
        ...
        # 测试心跳消息
        ping_message = {"type": MessageType.PING.value, "data": {}}
        ...
        # 测试订阅消息
        subscribe_message = {"type": MessageType.SUBSCRIBE.value, "data": {"subscription_type": "system_health"}}
        ...
        # 测试无效消息类型
        invalid_message = {"type": "invalid_type", "data": {}}
...
def test_file_structure():
    ...
    required_files = ["src/websocket/__init__.py", "src/websocket/monitoring_websocket.py"]
