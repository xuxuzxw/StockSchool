...
def main():
    ...
    total_passed = chart_passed + interactive_passed + responsive_passed + binding_passed + accessibility_passed
    total_tests = (
        len(results["chart_rendering"])
        + len(results["interactive_features"])
        + len(results["responsive_design"])
        + len(results["data_binding"])
