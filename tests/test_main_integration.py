...
async def test_main_imports():
    ...
    try:
        from src.api.main import app, MONITORING_AVAILABLE
        print("✅ 主应用模块导入成功")
...
async def test_dependency_injection():
    ...
    try:
        from src.api.main import (
            get_database, get_tushare_syncer, get_factor_engine,
            get_quality_monitor, get_feature_store, get_strategy_evaluator,
            get_alert_engine, get_monitoring_service
        )
...
async def test_monitoring_integration():
    ...
    try:
        ...
        # 测试WebSocket导入
        try:
            from src.websocket.monitoring_websocket import websocket_endpoint, get_websocket_server
