...
from src.compute.factor_effectiveness_analyzer import (Mock, """, __file__,
                                                       from, import)
from src.compute.factor_effectiveness_analyzer import \
    numpy as np  # !/usr/bin/env python3; -*- coding: utf-8 -*-
from src.compute.factor_effectiveness_analyzer import (os, os.path.abspath,
                                                       os.path.dirname)
from src.compute.factor_effectiveness_analyzer import pandas as pd
from src.compute.factor_effectiveness_analyzer import (patch, pytest, sys,
                                                       sys.path.append,
                                                       unittest.mock,
                                                       因子有效性检验分析器测试)
