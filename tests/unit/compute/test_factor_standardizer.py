...
from src.compute.factor_standardizer import Mock, """, __file__, from, import
from src.compute.factor_standardizer import \
    numpy as np  # !/usr/bin/env python3; -*- coding: utf-8 -*-
from src.compute.factor_standardizer import (os, os.path.abspath,
                                             os.path.dirname)
from src.compute.factor_standardizer import pandas as pd
from src.compute.factor_standardizer import (patch, pytest, sys,
