...
async def test_data_sync_collector():
    ...
    try:
        from src.monitoring.collectors import CollectorConfig, DataSyncCollector
...
async def test_factor_compute_collector():
    ...
    try:
        from src.monitoring.collectors import CollectorConfig, FactorComputeCollector
...
async def test_extended_system_collector():
    ...
    try:
        from src.monitoring.collectors import CollectorConfig, SystemHealthCollector
        ...
        # 验证组件数量总和
        total = summary["healthy_components"] + summary["warning_components"] + summary["critical_components"]
...
async def test_convenience_functions():
    ...
    try:
        from src.monitoring.collectors import (
            collect_ai_model_status,
            collect_data_sync_status,
            collect_factor_compute_status,
