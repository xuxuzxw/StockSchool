...
async def test_api_imports():
    ...
    try:
        from src.api.monitoring_api import (
            router, create_monitoring_router, initialize_monitoring_api,
            health_check, get_system_health, query_metrics, get_alerts,
            get_alert_stats, get_alert_rules, create_alert_rule,
            HealthCheckResponse, SystemHealthDetailResponse, MetricsQueryResponse,
            AlertRuleRequest, AlertRuleResponse, AlertRuleListResponse, StatsResponse
        )
        print("✅ 监控API模块导入成功")
        return True
...
async def test_dependency_injection():
    ...
    try:
        from src.api.monitoring_api import (
            get_monitoring_service, get_alert_engine, get_collectors
        )
...
async def test_system_health_endpoint():
    ...
    try:
        from src.api.monitoring_api import (
            get_system_health, get_monitoring_service, get_collectors
        )
...
async def test_alert_rules_endpoints():
    ...
    try:
        from src.api.monitoring_api import (
            get_alert_rules, create_alert_rule, get_alert_rule, delete_alert_rule,
            get_alert_engine, AlertRuleRequest
        )
...
async def test_metrics_query_endpoint():
    ...
    try:
        from src.api.monitoring_api import query_metrics, get_monitoring_service
...
async def test_alerts_endpoint():
    ...
    try:
        from src.api.monitoring_api import get_alerts, get_alert_stats, get_monitoring_service, get_alert_engine
...
async def test_realtime_endpoint():
    ...
    try:
        from src.api.monitoring_api import get_realtime_system_status, get_collectors
...
async def test_api_initialization():
    ...
    try:
        from src.api.monitoring_api import initialize_monitoring_api, create_monitoring_router
