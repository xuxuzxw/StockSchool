...
class FeatureStore:
    ...
    def store_feature_values(self, feature_id: str, data: pd.DataFrame) -> bool:
        ...
        try:
            ...
            with self.engine.connect() as conn:
                ...
                # 插入新数据
                feature_data.to_sql("feature_values", conn, if_exists="append", index=False, method="multi")
    ...
    def get_feature_values(
        ...
        try:
            ...
            params = {"feature_id": feature_id, "normalized": normalized}
    ...
    def get_feature_matrix(
        self, feature_ids: List[str], ts_codes: List[str] = None, trade_date: str = None, normalized: bool = True
    ) -> pd.DataFrame:
        """
        获取特征矩阵
        ...
        try:
            ...
            params = {"feature_ids": feature_ids, "normalized": normalized}
