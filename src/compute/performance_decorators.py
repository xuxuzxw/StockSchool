...
def cached_calculation(cache: Optional[FactorCalculationCache] = None, ttl_seconds: Optional[int] = None):
    """
    缓存计算结果的装饰器
...
def performance_optimized(enable_cache: bool = True, enable_timing: bool = True, enable_memory_monitor: bool = False):
    """
    综合性能优化装饰器
