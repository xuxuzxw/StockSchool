...
from .factor_models import CalculationStatus, FactorResult
...
class PerformanceMonitor:
    ...
    def update_metrics(self, results: List[FactorResult]):
        ...
        if self.metrics.total_calculations > 0:
            self.metrics.average_execution_time = self.metrics.total_execution_time / self.metrics.total_calculations
