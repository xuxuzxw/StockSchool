...
from .task_scheduler import TaskStatus, TaskExecution
from .factor_models import FactorType, CalculationStatus
    ...
    def _setup_default_alert_rules(self):
        ...
        self.alert_rules['high_failure_rate'] = {
            'condition': lambda metrics: (
                metrics.failed_tasks_1h > 0 and 
                metrics.failed_tasks_1h / (metrics.completed_tasks_1h + metrics.failed_tasks_1h) > 0.2
            ),
            ...
            try:
                ...
                if rule_config['condition'](metrics):
                    ...
                    if (last_alert_time and 
                        (current_time - last_alert_time).total_seconds() < rule_config['cooldown']):
                        continue
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'overall_statistics': {
                ...
                'avg_execution_time_seconds': (stats['total_execution_time'].total_seconds() / 
                                             max(1, stats['total_calculations']))
            },
