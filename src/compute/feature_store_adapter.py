...
class FeatureStoreAdapter:
    ...
    def calculate_and_store_factor(self, factor_name: str, ts_codes: List[str] = None,
                                 start_date: date = None, end_date: date = None,
                                 force_new_version: bool = False) -> Tuple[bool, str]:
        """
        计算并存储因子数据
    ...
    def batch_calculate_and_store(self, factor_names: List[str], ts_codes: List[str] = None,
                                start_date: date = None, end_date: date = None) -> Dict[str, Tuple[bool, str]]:
        """
        批量计算并存储因子
    ...
    def get_factor_data_with_version(self, factor_name: str, version_id: str = None,
    ...
    def compare_factor_versions(self, factor_name: str, version_id1: str, version_id2: str,
                              ts_codes: List[str] = None, start_date: date = None,
