...
from .factor_models import CalculationStatus, CalculationTask, FactorConfig, FactorMetadata, FactorResult, FactorType
...
class BaseFactorStandardizer(ABC):
    ...
    @abstractmethod
    def standardize(self, factor_values: pd.Series, method: str = "zscore") -> pd.Series:
        """
        标准化因子值
