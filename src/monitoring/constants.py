...
class MonitoringConstants:
    ...
    def from_config(cls, config: Dict[str, Any]) -> "MonitoringConstants":
        ...
        return cls(
            ...
            DEFAULT_EVENT_RETENTION_HOURS=config.get(
                "monitoring.event_retention_hours", cls.DEFAULT_EVENT_RETENTION_HOURS
            ),
            DEFAULT_PERFORMANCE_WINDOW_HOURS=config.get(
                "monitoring.performance_window_hours", cls.DEFAULT_PERFORMANCE_WINDOW_HOURS
            ),
