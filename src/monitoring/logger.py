...
class AlertManager:
    ...
    def add_alert_rule(self, rule_name: str, condition: callable, alert_level: AlertLevel, title: str, message: str):
        """添加告警规则"""
            ...
            try:
                if rule["condition"](data):
                    ...
                    if (
                        ...
                        or (datetime.now() - last_triggered).total_seconds() > suppression_duration * 60
                    ):
...
if __name__ == "__main__":
    ...
    # 创建日志器
    log_config = {"log_level": "DEBUG", "console_output": True, "file_output": True, "log_dir": "test_logs"}
    ...
    # 测试系统健康检查
    health_metrics = {"error_count": 15, "sync_status": "success", "cpu_usage": 75.5, "memory_usage": 60.2}  # 触发告警
    stock_logger.check_system_health(health_metrics)

    # 测试手动告警
    stock_logger.log_with_alert(LogLevel.ERROR, "手动测试告警", AlertLevel.MEDIUM, "测试告警", {"test": True})
