...
class ExplainerPerformanceMonitor:
    ...
    def record_request(self, start_time: float, success: bool = True, is_batch: bool = False, cache_hit: bool = False):
        """
        记录请求性能
        ...
        try:
            ...
            self.request_history.append(
                {"timestamp": datetime.now().isoformat(), "response_time": response_time, "success": success}
            )
    ...
    def get_recent_performance(self, minutes: int = 5) -> Dict[str, Any]:
        ...
        try:
            ...
            # 过滤最近的请求
            recent_requests = [r for r in self.request_history if datetime.fromisoformat(r["timestamp"]) > cutoff_time]
