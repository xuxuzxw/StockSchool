...
class StrategyCustomizer:
    ...
    def create_user_risk_profile(self, user_id: str, profile_data: Dict[str, Any]) -> Optional[RiskProfile]:
        ...
        try:
            # 验证数据
            required_fields = ['risk_tolerance', 'investment_experience', 'age_group', 
                             'income_level', 'investment_goals', 'time_horizon']
    ...
    def _calculate_strategy_match_score(self, 
                                      risk_profile: RiskProfile,
                                      template: StrategyTemplate) -> float:
        """计算策略匹配度"""
        try:
            score = 0.0
    ...
    def _customize_config_for_user(self, 
                                 default_config: Dict[str, Any],
        ...
        try:
            ...
            if 'stop_loss' in custom_config and custom_config['stop_loss']:
                custom_config['stop_loss'] = min(
                    custom_config['stop_loss'],
                    risk_profile.loss_tolerance
                )
    ...
    def _assess_recommendation_risk(self, 
        ...
        try:
            ...
            risk_assessment = {
                ...
                'volatility_risk': 'high' if top_strategy['expected_volatility'] > 0.25 else 
                                 'medium' if top_strategy['expected_volatility'] > 0.15 else 'low',
    ...
    def create_user_strategy(self, 
                           ...
                           template_id: str,
                           custom_config: Dict[str, Any],
                           investment_amount: float) -> Optional[UserStrategy]:
        """创建用户策略
    ...
    def _validate_custom_config(self, 
                              custom_config: Dict[str, Any],
                              template: StrategyTemplate) -> bool:
        """验证自定义配置"""
        try:
    ...
    def backtest_user_strategy(self, strategy_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            backtest_config = BacktestConfig(
                ...
                **{k: v for k, v in user_strategy.custom_config.items() 
