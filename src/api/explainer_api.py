...
async def explain_prediction(request: ExplainRequest):
    ...
    try:
        ...
        return ExplainResponse(status="success", explanation=explanation, timestamp=datetime.now().isoformat())
...
async def batch_explain(request: BatchExplainRequest):
    ...
    try:
        ...
        return BatchExplainResponse(status="success", explanations=results, timestamp=datetime.now().isoformat())
...
async def feature_importance(request: FeatureImportanceRequest):
    ...
    try:
        ...
        return FeatureImportanceResponse(
            status="success", importance=importance_records, timestamp=datetime.now().isoformat()
        )
