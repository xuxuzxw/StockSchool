...
class TestDatabaseManager:
    ...
    def _connect(self) -> None:
        ...
        try:
            ...
            self.engine = create_engine(
                connection_string, pool_size=5, max_overflow=10, pool_timeout=30, pool_recycle=3600, echo=False
            )
    ...
    def setup_test_environment(
        self, stock_codes: List[str] = None, start_date: str = "20240101", end_date: str = "20240131"
    ) -> bool:
        """设置测试环境
    ...
    def get_database_stats(self) -> Dict[str, Any]:
        ...
        Returns:
            数据库统计信息
        """
        stats = {"connection_status": self.check_connection(), "tables": {}, "total_rows": 0}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--action", choices=["setup", "cleanup", "stats", "check"], default="check", help="执行的操作")
    parser.add_argument("--start-date", type=str, default="20240101", help="开始日期")
    parser.add_argument("--end-date", type=str, default="20240131", help="结束日期")
    ...
    try:
        ...
        if args.action == "setup":
            success = manager.setup_test_environment(start_date=args.start_date, end_date=args.end_date)
